        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @hasanyrole('admin|kaprodi')
                    <<<<<<< HEAD <div class="menu-item">
                        <a class="menu-link {{ request()->is('admin/pendaftar') ? 'active' : '' }}"
                            href="{{ route('pd.index') }}">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                <span class="svg-icon svg-icon-2">
                                    ...
                                    <a class="menu-link {{ request()->is('pendaftar') ? 'active' : '' }}"
                                        ...
                                        <span class="menu-icon">
                                            ...
                                            <span class="svg-icon svg-icon-2">
                                                ...
                                                >>>>>>> c1b30f26e52425b9b4da402d87242044102211e4
                                            </span>
                            ...
                            @hasanyrole('admin|kaprodi')
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <<<<<<< HEAD <a
                                                class="menu-link {{ request()->is('admin/manajemen-user') ? 'active' : '' }}"
                            ...
                            @hasrole('dosen')
                                ...
                                <a class="menu-link" href="{{ url('admin/bimbingan-kp') }}">
                                    ...
                                    <span class="menu-title">Kerja Praktek</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('admin/bimbingan-proposal') ? 'active' : '' }}"
                                                href="{{ url('admin/bimbingan-proposal') }}">
                                                <a class="menu-link {{ request()->is('admin/bimbingan-proposal') ? 'active' : '' }}"
                                                    href="{{ url('admin/bimbingan-proposal') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                            ...
                            @hasanyrole('admin|kaprodi|dosen')
                                ...
                                <a class="menu-link" href="{{ url('admin/penguji-kp') }}">
                                    ...
                                    <span class="menu-title">Kerja Praktek</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('admin/penguji-proposal') ? 'active' : '' }}"
                                                href="{{ url('admin/penguji-proposal') }}">
                                                <a class="menu-link {{ request()->is('admin/penguji-proposal') ? 'active' : '' }}"
                                                    href="{{ url('admin/penguji-proposal') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
