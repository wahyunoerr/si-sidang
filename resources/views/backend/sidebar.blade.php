    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @role('mahasiswa')
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('/mahasiswa/daftar-kerja-praktek/tambah') ? 'active' : '' }}"
                            href="{{ url('/mahasiswa/daftar-kerja-praktek/tambah') }}">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                @hasrole('dosen')
                    ...
                    @hasanyrole('kaprodi')
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('/kaprodi/manajemen-jadwal/jadwal') ? 'active' : '' }}"
                                href="{{ url('/kaprodi/manajemen-jadwal/jadwal') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
