...
class ProposalpController extends Controller
{
            ...
            return Datatables::of($data)
                ...
                ->addColumn('status_lulus', function ($tam) {
                    if ($tam->status_proposal == 1) {
                        ...
                        $btn1 = '<a href="javascript:void(0)" title="Edit" class="btn btn-danger btn-sm" onclick="updatePenguji1(' . "'" . $tam->id . "'" . ')">Tdak Lulus</a>';
                    }
    ...
    public function updatePenguji1(Request $request, $id)
    {
        ...
        if ($data->status_proposal == 0) {
            ...
            $update = [
                'status_proposal' => $data->status_proposal == 1 ? 2 : 1
            ];
        }
