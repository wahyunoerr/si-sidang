...
class KpjController extends Controller
{
        ...
        if (Request()->ajax()) {
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = '<a href="javascript:void(0)" title="Edit" onclick="get(' . "'" . $row->id . "'" . ')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"><span class="svg-icon svg-icon-3">
