        ...
        if (Request()->ajax()) {
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn = $btn . '<a href="javascript:void(0)" title="Hapus" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm" onclick="show(' . "'" . $row->id . "'" . ')"><span class="svg-icon svg-icon-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
